...
public class Single extends AppCompatActivity {
    ...
    int countData = 0,countForRestTime = 0;
    ...
    Toast mToast = null;
    TextView txvDeviceName,txvHost,txvConnectState,txvWeightStack,txvExercise;
    Button btnScan,btnEdit,btnStartExercise,btnMachine,btnInitial,btnTempo,btnRM,btnComplete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentScanQRcode.setClass(Single.this, ScanQRcode.class);
        ...
        btnMachine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentInitialMachine.setClass(Single.this, InitialMachine.class);
                ...
                if(txvConnectState.getText() == "已連線") {
                    if (btnInitial.getText().equals("開始掃描")) {
                        ...
                        if(exists) {
                            ...
                            Toast.makeText(Single.this, "請先連線並設定機器參數!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(txvWeightStack.getText()!="機器參數設定中" && getWeightFlag && startFlag == false){
                    ...
                    AlertDialog.Builder dialog_list = new AlertDialog.Builder(Single.this);
            ...
            public void onClick(View v) {
                ...
                if(btnTempo.getText() == "關閉"){
                    ...
                    if(warning.length() == 0) {
                        ...
                        Toast.makeText(Single.this, "請輸入" + warning + "!", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    btnTempo.setText("關閉");
                }
        ...
        btnStartExercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(txvWeightStack.getText().equals("-")||txvWeightStack.getText().equals("機器參數設定中")) {
                    Toast.makeText(Single.this, "請稍後重量偵測", Toast.LENGTH_LONG).show();
                }else{
    ...
    public void onBackPressed() {
        if(txvConnectState.getText().equals("已連線")) {
            ...
            Toast.makeText(Single.this, "藍牙已斷開", Toast.LENGTH_SHORT).show();
            mService.disconnect();
        }
        super.onBackPressed();
    }
    ...
    private final BroadcastReceiver GattUpdateReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BLEService.ACTION_DATA_AVAILABLE)) {
                ...
                Log.e("Action","處理資料.");
                txvDeviceName.setText(mDevice.getAddress());
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        try {
                            ...
                            if (frequency == 50 && (countForFrequency % 2 == 0)){
                                ...
                                //休息讀秒
                                if(!startFlag && countGroup != 1 && !RMflag){
                                    if(countForRestTime % frequency == 0) {
                                        mToast = Toast.makeText(Single.this, "休息" + Integer.valueOf(countForRestTime / frequency + 10) + "秒", Toast.LENGTH_SHORT);
                                        mToast.show();
                    ...
                    private void leaveTime(int i) {
                        ...
                        if(countData == 0){
                            ...
                            if(Math.abs(TofData-restTofData) <= 15){
                                restTimeCount++;
                            }else{
                                restTimeCount = 0;
                                restTimeStart = countData;
                        ...
                        if((restTimeCount < i*frequency) && (restTimeCount % frequency == 0) && restTimeCount != 0){
                            mToast = Toast.makeText(Single.this, "靜止" + Integer.valueOf(restTimeCount / frequency) + "秒", Toast.LENGTH_SHORT);
                            mToast.show();
                            Handler handler = new Handler();
                            handler.postDelayed(new Runnable() {
                                @Override
    ...
    private void initialBluetooth() {
        ...
        if (mBtAdapter == null) {
            Toast.makeText(Single.this, "Bluetooth is not available", Toast.LENGTH_LONG).show();
            finish();
            return;
        }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("是", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                intent.setClass(Single.this, YoutubePlayer.class);
    ...
    private void readIdentity() {
        //讀取identity.csv取得個資
        File inFile = new File(MainActivity.CSV_FILE_PATH+"identityHost.csv");
        final StringBuilder sb = new StringBuilder();
        String readString;
        String[] arr;
        try {
                ...
                if(a == 2) {
                    ...
                    for (int i = 0; i < arr.length; i++) {
                        if(i == 0){
                            ...
                            height = Integer.parseInt(arr[i].trim());;
                        }else if(i == 2){
                            weight = Integer.parseInt(arr[i].trim());;
                        }else if(i == 3){
                            age = Integer.parseInt(arr[i].trim());;
                        }else if(i == 4){
                            gender = arr[i];
                        }
                    }
