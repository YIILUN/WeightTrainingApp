...
public class SetHostIdentity extends AppCompatActivity {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (warning == ""){
                    ...
                    //將個人資料儲存成檔案方便模式讀取
                    try {
                        bw = CsvWriter.createBW("identityHost.csv");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    try {
                    ...
                    Toast.makeText(SetHostIdentity.this, warning+"型態錯誤!", Toast.LENGTH_LONG).show();
                }
            }
